...
class UpdateDesignerScreen extends GetView<DesignerController> {
  UpdateDesignerScreen({super.key});
                ...
                CustomElevatedButton(
                    onPressed: () {
                      if (controller.nameController.value.text.isEmpty) {
                        ...
                        controller.updateDesigner().whenComplete(
                              () {
