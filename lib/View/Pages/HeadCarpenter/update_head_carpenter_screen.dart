...
class UpdateHeadCarpenterScreen extends GetView<HeadCarpenterController> {
  UpdateHeadCarpenterScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Update Head Carpenter"),
          centerTitle: true,
                ...
                CustomElevatedButton(
                    onPressed: () {
                      if (controller.nameController.value.text.isEmpty) {
                        ...
                        controller.updateHeadCarpenter().whenComplete(
                              () {
